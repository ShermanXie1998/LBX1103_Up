...
open class UIWaveView: UIView {
    ...
    open var borderColor: UIColor = UIColor(red: 0.35, green: 0.78, blue: 0.98, alpha: 1) {
        didSet{
            self.layer.borderColor = self.borderColor.cgColor
        }
    }
    
    open var color: UIColor = UIColor(red: 0.35, green: 0.78, blue: 0.98, alpha: 1)  {
        didSet{
    ...
    /// real wave color
    private var realWaveColor: UIColor = UIColor(red: 0.35, green: 0.78, blue: 0.98, alpha: 1)  {
        didSet {
            self.realWaveLayer.fillColor = self.realWaveColor.cgColor
        }
    }
    /// mask wave color
    private var maskWaveColor: UIColor = UIColor(red: 0.35, green: 0.78, blue: 0.98, alpha: 0.5)  {
        didSet {
